...
import org.acestream.sdk.helpers.SettingDialogFragment;
import org.videolan.vlc.R;

import java.util.ArrayList;

public class FolderPreferenceDialogFragment
        ...
        implements SettingDialogFragment.SettingDialogListener
{
    ...
    public static FolderPreferenceDialogFragment newInstance(String key) {
        final FolderPreferenceDialogFragment fragment =
                new FolderPreferenceDialogFragment();
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(which == mEntries.length - 1) {
                            ...
                            dialogFragment.setListener(FolderPreferenceDialogFragment.this);
                         ...
                         */
                        FolderPreferenceDialogFragment.this.onClick(dialog,
